...
> [!NOTE]
> 이 프로젝트의 기존 버전(v1)은 모든 파일과 함께 [news_room_v1](./news_room_v1) 폴더로 정리되었습니다.
...
- 네이버 뉴스 웹 구조 변경 시 작동에 영향을 받을 수 있습니다
- 무분별한 대량 요청은 서비스 이용 제한의 원인이 될 수 있습니다
- AI 기능 사용 시 Gemini API 키 필요 (무료 할당량 제한 있음)
